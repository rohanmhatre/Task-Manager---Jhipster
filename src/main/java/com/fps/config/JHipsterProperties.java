...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "FilmSolutions@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "FilmSolutions API";

        private String description = "FilmSolutions API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "FilmSolutions";
