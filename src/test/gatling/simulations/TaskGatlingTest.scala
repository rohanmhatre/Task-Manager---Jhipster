...
class TaskGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Task entity")
        ...
        .repeat(2) {
            ...
            .post("/api/tasks")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "name":"SAMPLE_TEXT", "description":"SAMPLE_TEXT", "date_assigned":"2020-01-01T00:00:00.000Z", "date_completion":"2020-01-01T00:00:00.000Z", "status":null, "priority":null}""")).asJSON
            .check(status.is(201))
